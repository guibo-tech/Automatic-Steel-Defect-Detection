input = ones(4,40); %incializa matriz de treino
target = ones(2,40); %inicializa matriz de resultados
for n = 1:20
    img = strcat('F:\Engenharia Mecatrônica\10º  Semestre\TCC\PDI-RNA\PDI RNA\Plano\','plano (',int2str(n),').jpg');
